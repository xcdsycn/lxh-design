package com.lxh.thread.basic.countdownlatch;
...
/**
 * 线程池中，超过队列中的线程到来的时候，就直接拒绝服务，产生 threadPoolRejectException
 * 而且，如果队列满了，但是线程池中的最大线程数可以满足并发需求，就不会产生异常 corePoolSize决定了执行任务的线程数 缓冲队列的长度，是系统的可以容忍的最大吞量要求
 *
 * @author lxh
 */
