...
public class ReflectUtil {
	...
	public static Object getObjectValue(Object o, String fieldName) {
		Object ret = null;
		if (o != null && StringUtil.isNotNullAndEmpy(fieldName)) {
			Field f = getFieldWithoutError(o.getClass(), fieldName);
			if (f != null) {
	...
	public static Field[] getDeclareFiledsWithFilter(Class<?> cls, CommonFilter<Field> filters) {
		// TODO Auto-generated method stub
		Field[] ret = null;
		
		if (cls != null) {
			Set<Field> tempSet = new HashSet<Field>();
