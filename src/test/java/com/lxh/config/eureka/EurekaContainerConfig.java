...
public class EurekaContainerConfig {
    ...
    public static class Initializer implements ApplicationContextInitializer<ConfigurableApplicationContext>{
        ...
        public void initialize(@NotNull ConfigurableApplicationContext configurableApplicationContext) {
            ...
            TestPropertyValues.of("eureka.client.serviceUrl.defaultZone=http://eureka:eureka@localhost:"
                    + eurekaServer.getFirstMappedPort().toString()
                    + "/eureka").applyTo(configurableApplicationContext);
            TestPropertyValues.of("eureka.client.fetchRegistry:false").applyTo(configurableApplicationContext);
        }
