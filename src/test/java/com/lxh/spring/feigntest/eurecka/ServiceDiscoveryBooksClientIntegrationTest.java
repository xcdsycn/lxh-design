package com.lxh.spring.feigntest.eurecka;

import com.lxh.config.eureka.EurekaContainerConfig;
import com.lxh.config.eureka.MockBookServiceConfig;
import com.lxh.spring.feigntest.Application;
import com.lxh.spring.feigntest.Book;
import com.lxh.spring.feigntest.BooksClient;
...
public class ServiceDiscoveryBooksClientIntegrationTest {
    @Autowired
